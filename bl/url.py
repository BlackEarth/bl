...
URL_REGEXP = re.compile(pattern, re.I+re.U)
...
"""
    ...
    @classmethod
    def finditer(C, string):
        """search the given string for URLs and return an iterator of matches."""
        return URL_REGEXP.finditer(string)
